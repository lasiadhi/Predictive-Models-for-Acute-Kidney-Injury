...
This code will produce threshold vs performce plots for preOP results
"""
...
def plot_performance_measure(list_df,list_labels,cutoffs1,cutoffs2,x=10, y=5.7):
    ...
    for df,l,c, c2 in zip(list_df,list_labels,cutoffs1, cutoffs2):
        ...
        #ax.text(0.18, 0.4, 'Cutoff-1 \n 0.17', fontdict=font_cut)
        #ax.text(0.37, 0.61, 'Cutoff-2 \n 0.43', fontdict=font_cut)
...
if __name__ == '__main__':
    ...
    #FILENAME_results = 'Results/AKI_3/yellow+green+purple_dropped_model/aki3Day_PreOp_trainBy2039_ROC_AUC_ACC_PPV_NPV_F1_874testData_yellow+green+purple_dropped.csv'
    #FILENAME_results = 'Results/AKI_7/yellow+green+purple_dropped_model/aki7Day_PreOp_trainBy2039_ROC_AUC_ACC_PPV_NPV_F1_874testData_yellow+green+purple_dropped.csv'
    FILENAME_results = 'Results/AKI_7/esrd_dropped_final_features_model/aki7Day_PreOp_trainBy2038_ROC_AUC_ACC_PPV_NPV_F1_873testData_esrd_dropped.csv'

    df_perf = pd.read_csv(FILENAME_results, index_col=False)
    
    list_df = [df_perf.iloc[0:99,]]
    ...
    #performance_fig.savefig('aki7_trainBy2038_PreOp_Performance_873TestData.svg', format='svg', dpi=300)