...
data_train <- read.csv("Data_to_train/TrainData_with_akiOverall_2038samples_drop_esrd_patient.csv",header = TRUE) # training data
data_test <- read.csv("Data_to_test/TestData_with_akiOverall_drop_esrd_patient.csv",header = TRUE) #testing data
...
proc_data <- gen_proc_data(data_raw,features_selected,data_raw$aki_overall) #generate data for modelling
...
#write.csv(metric_kdigo_corr,"akiOverall_PreOp_trainBy2038_ROC_AUC_ACC_PPV_NPV_F1_trainData_esrd_dropped.csv")
...
write.csv(cbind(data_test$acc,data_new_kdigo_corr[,c('kdigo_corrpred','outcome')]),"akiOverall_preOp_trainBy2038_prediction_result_on873Test_esrd_dropped.csv")
write.csv(metric_kdigo_corr_test,"akiOverall_PreOp_trainBy2038_ROC_AUC_ACC_PPV_NPV_F1_873testData_esrd_dropped.csv")
...
roc_obj <- roc(data_new_kdigo_corr$outcome, data_new_kdigo_corr$kdigo_corrpred)
svg('AKIOverall_PreOp_trainBy2038_ROC_with_873testData_esrd_dropped.svg')
...
write.csv(data_all,"akiOverall_PreOp_trainBy2038_predScore_for_wholeCohort_esrd_Dropped.csv")  # write the predition on the whole cohort to input as a feature to the intraOp model
