...
if __name__ == '__main__':
    ...
    FILENAME_results = 'Results/AKI_Overall/IntraOp+PreOp_probs_drop_esrd/akiOverall_IntraOp+preOP_ROC_AUC_ACC_PPV_NPV_F1_TestData.csv'
    ...
    #performance_fig.savefig('akiOverall_IntraO+preOP_probs_Performance_873TestData.svg', format='svg', dpi=300)