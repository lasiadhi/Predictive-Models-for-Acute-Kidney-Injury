# apply t-test and chi-square test to compare two unpaired groups
...
# CHANGE HERE
# read intraop  data
intraop_data <- read.csv("Model/Data/akiOverall_drop_esrd1_patients/all_clean_feature_to_model_akiOverall.csv",header = TRUE)
outcome <- intraop_data$aki_overall
...
write.csv(df,"comparison_stat_results_for_intraOp_akiOverall_with_wilcoxon_rank_sum.csv")
