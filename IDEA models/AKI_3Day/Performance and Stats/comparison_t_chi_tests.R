...
# CHANGE HERE
# read intraop  data
intraop_data <- read.csv("Model/Data/aki3_drop_esrd1_patients/all_clean_feature_to_model_aki3.csv",header = TRUE)
outcome <- intraop_data$aki3day
...
write.csv(df,"comparison_stat_results_for_intraOp_aki3Day_with_wilcoxon_rank_sum.csv")
