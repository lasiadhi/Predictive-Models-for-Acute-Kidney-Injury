...
data_results <- read.csv("Model/Results/AKI_3Day/IntraOp+PreOp_fullData_drop_esrd/aki3Day_full_model_Fulldata_prediction_from_train2038.csv",header = TRUE) #testing data or train data
...
write.csv(metric_kdigo_corr,"aki3Day_PostOp_Full_model_ROC_AUC_ACC_PPV_NPV_F1_trainData.csv")
...
############################3 for testing data ###############################
data_results <- read.csv("Model/Results/AKI_3Day/IntraOp+PreOp_fullData_drop_esrd/aki3Day_intraOP+preOPFulldata_prediction_from_test873.csv",header = TRUE) #testing data
...
#write.csv(cbind(data_test$acc,data_new_kdigo_corr[,c('kdigo_corrpred','outcome','category')]),"aki3Day_prediction_result.csv")
write.csv(metric_kdigo_corr,"aki3Day_post_full_model_ROC_AUC_ACC_PPV_NPV_F1_TestData.csv")
