...
data_results <- read.csv("Model/Results/AKI_3Day/IntraOp+PreOp_probs_probs_drop_esrd/aki3Day_prediction_from_intraOP+preOP_probs_from_train2038.csv",header = TRUE) #testing data or train data
...
write.csv(metric_kdigo_corr,"aki3Day_IntraOp+preOP_ROC_AUC_ACC_PPV_NPV_F1_TrainData.csv")
...
#svg('AKI3Day_fromIntraOp+PreOP_ROC_with_874testData.svg')
