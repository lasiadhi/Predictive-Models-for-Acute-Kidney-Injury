...
if __name__ == '__main__':
    ...
    FILENAME_results = 'Results/AKI_3Day/IntraOp+PreOp_probs_probs_drop_esrd/aki3Day_IntraOp+preOP_ROC_AUC_ACC_PPV_NPV_F1_testData.csv'
    
    df_perf = pd.read_csv(FILENAME_results, index_col=False)
    
    list_df = [df_perf.iloc[0:95,]]
    ...
    #performance_fig.savefig('aki3Day_IntraO+preOPProbs_Performance_873TestData.svg', format='svg', dpi=300)