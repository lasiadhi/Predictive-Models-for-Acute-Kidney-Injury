...
if __name__ == '__main__':
    ...
    FILENAME_results = 'Results/AKI_3Day/IntraOp+PreOp_probs_probs_drop_esrd/aki3Day_IntraOp+preOP_ROC_AUC_ACC_PPV_NPV_F1_TrainData.csv'
    
    df_perf = pd.read_csv(FILENAME_results, index_col=False)
    
    list_df = [df_perf.iloc[0:97,]]
    ...
    #performance_fig.savefig('aki3Day_IntraOp+preOpProb_cutoffs_fromTrain.svg', format='svg', dpi=300)