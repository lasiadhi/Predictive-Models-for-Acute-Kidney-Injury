...
if __name__ == '__main__':
    ...
    FILENAME_X_train = "IntraOp_model-DECLARE/Model/Data/aki7_drop_esrd1_patients/aki7Day_X_train.csv"
    FILENAME_X_test = "IntraOp_model-DECLARE/Model/Data/aki7_drop_esrd1_patients/aki7Day_X_test.csv"
    FILENAME_y_train = "IntraOp_model-DECLARE/Model/Data/aki7_drop_esrd1_patients/aki7Day_y_train.csv"
    FILENAME_y_test = "IntraOp_model-DECLARE/Model/Data/aki7_drop_esrd1_patients/aki7Day_y_test.csv"
    ...
    FILENAME_preds_from_preOp = "IntraOp_model-DECLARE/PreOp_model/Results/AKI_7/esrd_dropped_final_features_model/aki7Day_PreOp_trainBy2038_predScore_for_wholeCohort_esrd_Dropped.csv"
...
#    
    ...
    #dff.to_csv('important_features_f_value_aki7_intra+preOp_fullData.csv',index=False)
...
#    plt.plot(fpr, tpr, lw=1, color='green', label='Logistic GAM (%0.2f)'% roc_auc)
    ...
    #df_results.to_csv("aki7Day_full_model_Fulldata_prediction_from_train2038.csv",index=False)
