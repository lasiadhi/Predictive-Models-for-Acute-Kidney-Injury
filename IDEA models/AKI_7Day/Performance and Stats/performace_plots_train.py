...
def plot_performance_measure(list_df,list_labels,cutoffs1,cutoffs2,x=10, y=5.7):
    ...
    for df,l,c, c2 in zip(list_df,list_labels,cutoffs1, cutoffs2):
        ...
        ax.text(0.42, 0.85, 'Cutoff \n 0.41', fontdict=font_cut)
...
if __name__ == '__main__':
    ...
    FILENAME_results = 'Results/AKI_7Day/IntraOp+PreOp_probs_drop_esrd/aki7Day_IntraOp+preOP_ROC_AUC_ACC_PPV_NPV_F1_trainData.csv'
    ...
    #performance_fig.savefig('aki7Day_IntraOp+preOp_probs_cutoffs_fromTrain.svg', format='svg', dpi=300)