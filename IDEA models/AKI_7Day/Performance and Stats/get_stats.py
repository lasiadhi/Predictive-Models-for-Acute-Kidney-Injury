...
This code generates basic descriptive statistics for the given dataset - AKI-7Day
...
if __name__ == '__main__':
    ...
    df_features.aki7day = df_features.aki7day.astype('category', categories=[0,1])
    ...
    dd_for_outcome = generate_stats_for_continous(df_features, my_dic, outcome='aki7day', isNormal=True)  # compute descriptives for each outcome seperately. Change the outcome label name here. 
    ...
    #df.to_csv('intraOp_stats_for_continous_vars_aki7_MEAN.csv', index=True)
    ...
    df_cat = generate_stats_for_cat(df_features, my_dic, outcome='aki7day')  # compute stats for each outcome category
    ...
    #df_final.to_csv('intraOp_stats_for_cat_vars_aki7.csv', index=True)  
