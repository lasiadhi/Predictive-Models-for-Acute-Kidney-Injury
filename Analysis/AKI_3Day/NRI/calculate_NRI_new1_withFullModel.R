# Lasith Adhikari
# Computing NRI for AKI-3Day: Postop full model Vs. PreOp model 
...
preds <- read.csv("Analysis/AKI_3Day/Data/categorized_results_preOp+intraPreOp.csv",header = TRUE) # data


cutoff_preOp = 0.25
#cutoff_intraPreOp = 0.41
cutoff_intraPreOp =  0.38    # full model cutoff
