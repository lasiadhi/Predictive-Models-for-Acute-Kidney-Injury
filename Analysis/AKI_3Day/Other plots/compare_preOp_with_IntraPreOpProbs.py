...
def plotting(df):
    ...
    fig.savefig('comparison_plot_preOpVsintraPreOp_forAKI.svg', format='svg', dpi=300)
...
if __name__ == '__main__':
    ...
    FILENAME_intraOp_results = "Model/Results/AKI_3Day/IntraOp+PreOp_probs_probs_drop_esrd/aki3Day_prediction_from_intraOP+preOP_probs_from_test873.csv"
    FILENAME_preOp_results = "PreOp_model/Results/AKI_3/esrd_dropped_final_features_model/aki3Day_preOp_trainBy2038_prediction_result_on873Test_esrd_dropped.csv"
    #write:
