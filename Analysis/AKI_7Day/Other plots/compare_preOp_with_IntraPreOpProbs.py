...
def generate_data():
    ...
    df.columns = ['acc', 'true_AKI7_outcome', 'pred_from_intraPreOp', 'pred_from_preOp']
...
if __name__ == '__main__':
    ...
    FILENAME_intraOp_results = "Model/Results/AKI_7Day/IntraOp+PreOp_probs_drop_esrd/aki7Day_prediction_from_intraOP+preOP_probs_from_test874.csv"
    FILENAME_preOp_results = "PreOp_model/Results/AKI_7/esrd_dropped_final_features_model/aki7Day_preOp_trainBy2038_prediction_result_on873Test_esrd_dropped.csv"
    ...
    ff = plotting(df)
    #ff.savefig('comparison_plot_preOpVsintraPreOp_forNOAKI_aki7.svg', format='svg', dpi=300)
