...
ind <- which(data_fnl$outcome==1& data_fnl$kdigo_corrpred<=preOp_cutoff)
...
legend("topright",c("Low risk in intraOp+preOp","High risk in intraOp+preOp"),pch=c(16,16),col=c("green","red"))
cols <- c("green","red") ; 
for(i in 1:2){
