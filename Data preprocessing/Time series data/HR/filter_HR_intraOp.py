...
This code filter out HR values those are out side of the surgery time
"""
...
def isIntraOp_lab():
    ...
    TS_df = pd.read_csv(FILENAME_TS, index_col=False, iterator=True, chunksize=30000)
    for df in TS_df:
...
if __name__ == '__main__':
    ...
    FILENAME_TS = "Time_series/Clean_data/HR_cleaned_data.csv"

    #Write
    FILENAME_selected_TS = "HR_onlyIntraOp.csv"
    FILENAME_selected_TSYN = "HR_interOpYN.csv"
